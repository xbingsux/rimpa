      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Transform.translate(
              ...
              child: const Text(
                'ข้อมูลส่วนตัว',
                style: TextStyle(fontSize: AppTextSize.xl, fontWeight: FontWeight.bold),
              )),
                      ...
                      GestureDetector(
                        onTap: () async {
                          DateTime? pickedDate = await DatePicker.showSimpleDatePicker(
                            ...
                            itemTextStyle: const TextStyle(fontSize: 18, fontWeight: FontWeight.w500),
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      const Padding(
                        padding: EdgeInsets.all(AppSpacing.sm),
                        child: Text('รหัสผ่าน', style: TextStyle(fontSize: AppTextSize.md, color: AppTextColors.secondary)),
                      ),
                      Obx(
                        () => Stack(
                          ...
                          children: [
                            TextField(
                              ...
                              obscureText: registerController.obscurePass1.value,
                              style: const TextStyle(color: AppTextColors.secondary, fontSize: AppTextSize.md),
                              decoration: InputDecoration(
                                  contentPadding: const EdgeInsets.symmetric(horizontal: AppSpacing.lg),
                                  hintText: 'รหัสผ่าน',
                            ...
                            GestureDetector(
                              onTap: () => registerController.obscurePass1.value = !registerController.obscurePass1.value,
                              child: Container(
                                decoration: const BoxDecoration(),
                                padding: const EdgeInsets.only(right: AppRadius.sm),
                                child: Icon(
                                  registerController.obscurePass1.value ? Icons.visibility_outlined : Icons.visibility_off_outlined,
                                  size: AppTextSize.xxl,
                                  color: AppTextColors.secondary,
                                ),
                              ),
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      const Padding(
                        padding: EdgeInsets.all(AppSpacing.sm),
                        child: Text('ยืนยันรหัสผ่าน', style: TextStyle(fontSize: AppTextSize.md, color: AppTextColors.secondary)),
                      ),
                      Obx(
                        () => Stack(
                          alignment: Alignment.centerRight,
                          children: [
                            TextField(
                              ...
                              obscureText: registerController.obscurePass2.value,
                              style: const TextStyle(color: AppTextColors.secondary, fontSize: AppTextSize.md),
                              decoration: InputDecoration(
                                  contentPadding: const EdgeInsets.symmetric(horizontal: AppSpacing.lg),
                            ...
                            GestureDetector(
                              onTap: () => registerController.obscurePass2.value = !registerController.obscurePass2.value,
                              child: Container(
                                decoration: const BoxDecoration(),
                                padding: const EdgeInsets.only(right: AppRadius.sm),
                                child: Icon(
                                  registerController.obscurePass2.value ? Icons.visibility_outlined : Icons.visibility_off_outlined,
                                  size: AppTextSize.xxl,
                                  color: AppTextColors.secondary,
                                ),
                              ),
