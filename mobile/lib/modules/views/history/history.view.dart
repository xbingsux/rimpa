...
enum HistoryType { all, earn, redeem }
...
class HistoryView extends StatelessWidget {
            ...
            child: Obx(() => SingleChildScrollView(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      historyTypeButton(
                          context,
                          historyController.activeType.value ==
                              HistoryType.earn, () {
  ...
  Widget historyTypeButton(
      BuildContext context, bool isActive, Function onTap, String buttonText) {
    return Padding(
  ...
  Widget historyDisplay(
      BuildContext context, List<HistoryPointModel> historyList) {
    if (historyList.isNotEmpty) {
      return Expanded(
        child: SingleChildScrollView(
          child: Padding(
            padding: const EdgeInsets.only(
                left: AppRadius.md, right: AppRadius.md, bottom: AppRadius.md),
            child: Column(
              children: List.generate(
                ...
                (index) {
                  return Padding(
                    padding:
                        EdgeInsets.only(top: index == 0 ? 0.0 : AppSpacing.md),
                    child: AppCardComponent(
                      ...
                      incardPadding: const EdgeInsets.symmetric(
                              ...
                              child: Padding(
                                ...
                                child: Container(
                                    ...
                                    child: AppImageComponent(
                                      ...
                                      imageAddress:
                                          historyList[index].type == 'REDEEM'
                                              ? 'assets/icon/history/redeem.png'
                                              : 'assets/icon/history/earn.png',
                                      aspectRatio: 1 / 1,
                                    )),
                              ),
                            ),
                                ...
                                children: [
                                  ...
                                  Text(
                                    DateFormat('dd/MM/yyyy HH:mm')
                                        .format(historyList[index].updatedAt),
                                    style: Theme.of(context)
                                        .textTheme
                                        .bodyMedium!
                                        .copyWith(
